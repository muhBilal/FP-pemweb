                            ...
                            <section className={`flex flex-col md:flex-row gap-5 mt-2`}>
                                <div className={`w-full md:w-[80%] pr-0 md:pr-5`}>
                                    <div className={`bg-white rounded-xl `}>
                                        <img
                                            src={process.env.NEXT_PUBLIC_STORAGE + animalData.image_thumbnail}
                                            alt="animal"
                                        ...
                                        >
                                            <div className={`w-full pr-3 px-6`}>
                                                <div className={`flex gap-5 items-center mb-3`}>
                                                    ...
                                                    <h1 className={`text-gray-400 text-sm`}>{animalData.createdAt}</h1>
                                                </div>
                                ...
                                >
                                    <div className={`flex justify-between mb-5 items-center`}>
                                        <h1 className={`font-bold text-xl`}>Hewan Lainnya</h1>
                                        <Link href={`/animals`} className={`text-blue-500 text-sm`}>
                                            See More
                                        </Link>
                                    </div>
                                        ...
                                        {shuffle.map((animal, index) => (
                                            <div key={index} className="hover:shadow-md transition-all">
                                                <Link href={'/animals/' + animal.id}>
                                                    <img
                                                        src={`${process.env.NEXT_PUBLIC_STORAGE}${animal.image_thumbnail}`}
                                                        alt="animals"
                                                    ...
                                                    <div className="bg-white rounded-bl-lg rounded-br-lg p-2">
                                                        ...
                                                        <div className={`text-gray-500 text-sm`}
                                                            dangerouslySetInnerHTML={{ __html: animal.desc.substring(0, 100) + '...' }}/>
                                                    </div>
                                                </Link>
                                            </div>
                                        ))}
