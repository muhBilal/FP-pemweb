                ...
                <section class="flex justify-between items-center mb-10">
                    ...
                    <form class="w-80" method="POST">
                        ...
                        <div class="relative flex">
                            ...
                            <input name="search" type="search" id="default-search" class="block bg-gray-100 w-full p-4 pl-12 text-sm text-black border border-gray-400 rounded-full focus:ring-[#1A2035] focus:border-none focus:bg-white" placeholder="Cari Nama Makanan Daerah ..." required onchange="searchMakananDaerah(this.value)" />
                ...
                <section class="mt-5">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
                        <?php foreach ($makanan_daerah as $makanan) { ?>
                            <a href="./detail.php?id=<?= $makanan['id'] ?>" class="group cursor-pointer hover:shadow-sm transition-all duration-500 relative rounded-3xl">
                                <img src="<?= $appUrl.$makanan['image_url'] ?>" alt="<?= htmlspecialchars($makanan['name'], ENT_QUOTES, 'UTF-8'); ?>" class="w-full h-[400px] object-cover rounded-3xl" />
