                            ...
                            <tbody>
                                <?php foreach ($tariDaerah as $tari) { ?>
                                    <tr>
                                        ...
                                        <td class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                            <a href="/FP-pemweb/pages/admin/tari-daerah/update.php?id=<?php echo $tari['id']; ?>" class="text-xs font-semibold leading-tight dark:text-white dark:opacity-80 text-slate-400">Update</a>
