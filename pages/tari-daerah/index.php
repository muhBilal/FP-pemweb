                ...
                <section class="flex justify-between items-center mb-10">
                    ...
                    <form class="w-80" method="POST">
                        ...
                        <div class="relative flex">
                            ...
                            <input name="search" type="search" id="default-search" class="block bg-gray-100 w-full p-4 pl-12 text-sm text-black border border-gray-400 rounded-full focus:ring-[#1A2035] focus:border-none focus:bg-white" placeholder="Cari Nama Tari Daerah ..." required />
                    ...
                    <nav class="flex" aria-label="Breadcrumb">
                        <ol class="inline-flex items-center space-x-1 md:space-x-3">
                            <li class="inline-flex items-center">
                                <a href="../../pages/home.php" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600">
                            ...
                            <li aria-current="page">
                                <div class="flex items-center">
                                    ...
                                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Tari Daerah</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
                ...
                <section class="mt-5">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
                        <?php foreach ($tari_daerah as $tari) { ?>
                            <a href="./detail.php?id=<?= $tari['id'] ?>" class="group cursor-pointer hover:shadow-sm transition-all duration-500 relative rounded-3xl">
                                <img src="<?= $tari['image_url']?>" alt="<?= $tari['name'] ?>" class="w-full h-[400px] object-cover rounded-3xl"/>
                                <div class="bg-[#1A2035] text-gray-200 p-5 absolute bottom-0 rounded-3xl w-full">
                                    <p class="text-xl font-bold my-2 hover:text-blue-600 transition-all"><?= $tari['name'] ?></p>
                                    <div class="overflow-hidden transition-all duration-500 max-h-0 group-hover:max-h-[200px]">
                                        <div class="text-gray-300 mt-3 text-sm"><?= $tari['description'] ?></div>
                                    </div>
                                </div>
                            </a>
                        <?php } ?>
