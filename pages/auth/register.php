...
<body>
<section class="h-screen flex gap-5 w-full p-4">
      <div class="w-full md:w-[40%] font-poppins">
        <img
          src="../../public/images/sidebar-logo.webp"
          alt=""
          class="w-36 h-12 object-cover"
        />
        <div class="px-7">
          <div class="px-9">
            <h1 class="font-bold text-3xl mt-14">Buat Akun</h1>
            ...
            <form class="mt-5">
              ...
              <button type="button" onClick=handleSubmit(HandleLogin) class="px-4 py-3 bg-[#1A2035] hover:bg-gradient-to-br rounded-md text-white outline-none shadow-lg transform active:scale-x-75 transition-transform focus:ring-4 focus:ring-primary w-full">
                <span class="font-2xl">Daftar</span>
              </button>
              <p class="text-gray-400 my-5">
                Sudah mempunyai akun?{" "}
                <Link
                  href="/login"
                  class="text-gray-600 font-bold cursor-pointer hover:text-blue-500"
                >
                  Masuk sekarang
                </Link>
              </p>
      ...
      <div class="w-[60%] relative hidden md:block">
        <img
          src="../../public/images/culture1.webp"
          alt=""
