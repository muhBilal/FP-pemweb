                ...
                <section class="flex justify-between items-center mb-10">
                    ...
                    <form class="w-80" method="POST">
                        ...
                        <div class="relative flex">
                            ...
                            <input name="search" type="search" id="default-search" class="block bg-gray-100 w-full p-4 pl-12 text-sm text-black border border-gray-400 rounded-full focus:ring-[#1A2035] focus:border-none focus:bg-white" placeholder="Cari Nama Pakaian Adat ..." required onchange="searchPakaianAdat(this.value)" />
