...
<body>
    <main class="h-screen flex gap-5 w-full p-4">
        <div class="w-full md:w-[40%] font-poppins">
            ...
            <div class="px-7">
                <div class="px-9">
                    <h1 class="font-bold text-3xl mt-14">Masuk</h1>
                    ...
                    <div class="mb-6">
                        ...
                        <button type="button" onClick=handleSubmit(HandleLogin) class="btn-primary w-full">
        ...
        <div class="w-[60%] relative hidden md:block">
            ...
            <img src="../../public/images/animal.webp" alt="" class="h-full w-full object-cover rounded-2xl" />
